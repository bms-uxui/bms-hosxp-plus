...
import 'patient_list_o_p_d_model.dart';
export 'patient_list_o_p_d_model.dart';

class PatientListOPDWidget extends StatefulWidget {
  const PatientListOPDWidget({super.key});

  static String routeName = 'Patient_list_OPD';
  static String routePath = 'patientListOPD';

  @override
  State<PatientListOPDWidget> createState() => _PatientListOPDWidgetState();
}

class _PatientListOPDWidgetState extends State<PatientListOPDWidget>
    with TickerProviderStateMixin {
  late PatientListOPDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientListOPDModel());
                        ...
                        builder: (context) {
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: FillterExaminationroomOPDWidget(),
                            ),
                          );
                        },
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Wrap(
                                        ...
                                        children: [
                                          wrapWithModel(
                                            model: _model.chronicDiseaseModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ChronicDiseaseWidget(),
                                          ),
                                          wrapWithModel(
                                            model:
                                                _model.congenitalDiseaseModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: CongenitalDiseaseWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.drugAllergyModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: DrugAllergyWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.surgicalHistoryModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: SurgicalHistoryWidget(),
                                          ),
                                        ],
                                      ),
                                      Container(
                                                      ...
                                                      children: [
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Expanded(
                                                              child: Text(
                                                                'A959 : Acute nasopharyingitis [common cold] , K591 : Functional diarrhoea',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
                                                                    .override(
