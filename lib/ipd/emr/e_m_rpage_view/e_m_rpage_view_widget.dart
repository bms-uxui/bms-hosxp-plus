...
import 'e_m_rpage_view_model.dart';
export 'e_m_rpage_view_model.dart';

class EMRpageViewWidget extends StatefulWidget {
  const EMRpageViewWidget({super.key});

  @override
  State<EMRpageViewWidget> createState() => _EMRpageViewWidgetState();
}

class _EMRpageViewWidgetState extends State<EMRpageViewWidget> {
  late EMRpageViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EMRpageViewModel());
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Stack(
                    children: [
                      if (FFAppState().ExpanVisitListEMR == false)
                        Container(
                          width: () {
                                ...
                                children: [
                                  if (FFAppState().ExpanVisitListEMR == false)
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        FFAppState().ExpanVisitListEMR = true;
                                        safeSetState(() {});
                                      },
                                      child: wrapWithModel(
                      ...
                      if (FFAppState().ExpanVisitListEMR == true)
                        InkWell(
                          splashColor: Colors.transparent,
                          focusColor: Colors.transparent,
                          hoverColor: Colors.transparent,
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            FFAppState().ExpanVisitListEMR = false;
                            safeSetState(() {});
                          },
                          child: wrapWithModel(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      FFAppState().EMRVisit = 1;
                                      safeSetState(() {});
                                    },
                                    child: wrapWithModel(
                                      model: _model.itemEMRIPDModel1,
                                      updateCallback: () => safeSetState(() {}),
                                      child: ItemEMRIPDWidget(
                                        date: '12 มิ.ย.',
                                  ...
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      FFAppState().EMRVisit = 2;
                                      safeSetState(() {});
                                    },
                                    child: wrapWithModel(
                                      model: _model.itemEMROPDModel1,
                                      updateCallback: () => safeSetState(() {}),
                                      child: ItemEMROPDWidget(
                                        date: '5 มิ.ย.',
                                        department: 'อายุรกรรม',
                                        time: '10:00',
                                        emrvisit: 2,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      FFAppState().EMRVisit = 3;
                                      safeSetState(() {});
                                    },
                                    child: wrapWithModel(
                                      model: _model.itemEMROPDModel2,
                                      updateCallback: () => safeSetState(() {}),
                                      child: ItemEMROPDWidget(
                                        date: '7 มี.ค.',
                                        department: 'อายุรกรรม',
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      FFAppState().EMRVisit = 4;
                                      safeSetState(() {});
                                    },
                                    child: wrapWithModel(
                                      model: _model.itemEMRIPDModel2,
                                      updateCallback: () => safeSetState(() {}),
                                      child: ItemEMRIPDWidget(
                                        date: '12 ก.พ.',
                                        department: 'อายุรกรรม',
                ...
                children: [
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/Frame_1686560262.png',
                                      width: 60.0,
                                      height: 60.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/Frame_1686560263.png',
                                      width: 60.0,
                                      height: 60.0,
                                      fit: BoxFit.cover,
                                    ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        model: _model.itemAppiontmentModel,
                        updateCallback: () => safeSetState(() {}),
