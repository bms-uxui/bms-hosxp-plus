...
import 'diag_view_model.dart';
export 'diag_view_model.dart';

class DiagViewWidget extends StatefulWidget {
  const DiagViewWidget({super.key});

  @override
  State<DiagViewWidget> createState() => _DiagViewWidgetState();
}

class _DiagViewWidgetState extends State<DiagViewWidget> {
  late DiagViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiagViewModel());
