...
import 'add_xray_model.dart';
export 'add_xray_model.dart';

class AddXrayWidget extends StatefulWidget {
  const AddXrayWidget({super.key});

  static String routeName = 'Add_Xray';
  static String routePath = 'addXray';

  @override
  State<AddXrayWidget> createState() => _AddXrayWidgetState();
}

class _AddXrayWidgetState extends State<AddXrayWidget>
    with TickerProviderStateMixin {
  late AddXrayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddXrayModel());
                                                          ...
                                                          child: Padding(
                                                            padding: MediaQuery
                                                                .viewInsetsOf(
                                                                    context),
                                                            child:
                                                                ButtonsheetLabPriorityLevelsWidget(),
                                                          ),
                                                        );
                                                      },
                                                    ).then((value) =>
                                                              ...
                                                              child: Padding(
                                                                padding: MediaQuery
                                                                    .viewInsetsOf(
                                                                        context),
                                                                child:
                                                                    ButtonsheetLocationOrdererWidget(),
                                                              ),
                                                            );
                                                          },
                                                        ).then((value) =>
                                      ...
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.asset(
                                              'assets/images/ChatGPT_Image_11_.._2568_09_42_37.png',
                                              width: 60.0,
                                              height: 60.0,
                                              fit: BoxFit.cover,
                                            ),
