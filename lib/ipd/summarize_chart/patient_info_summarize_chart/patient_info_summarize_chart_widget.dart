...
import 'patient_info_summarize_chart_model.dart';
export 'patient_info_summarize_chart_model.dart';

class PatientInfoSummarizeChartWidget extends StatefulWidget {
  const PatientInfoSummarizeChartWidget({super.key});

  static String routeName = 'Patient_Info_SummarizeChart';
  static String routePath = 'patientInfoSummarizeChart';

  @override
  State<PatientInfoSummarizeChartWidget> createState() =>
      _PatientInfoSummarizeChartWidgetState();
}

class _PatientInfoSummarizeChartWidgetState
    extends State<PatientInfoSummarizeChartWidget>
    with TickerProviderStateMixin {
  late PatientInfoSummarizeChartModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientInfoSummarizeChartModel());
                                  ...
                                  if (FFAppState().TabMenuPatientInfo == 1) {
                                    return Padding(
                                      ...
                                      child: wrapWithModel(
                                        ...
                                        child: AdmitpageViewWidget(
                                          buttonReport: false,
                                          crossAxisCount: 2,
                                          crossAxisCountcard: 1,
                                        ),
                                      ),
                                    );
                                  } else if (FFAppState().TabMenuPatientInfo ==
                                      2) {
                                    ...
                                    return wrapWithModel(
                                      ...
                                      child: VitalsignpageViewWidget(
                                        buttonaddTreatment: false,
                                        crossAxisCount: 2,
                                        bottonAddNursRecod: false,
                                        buttonaddNursPromple: false,
                                        sizemenu: 48.0,
                                      ),
                                    );
                                  } else if (FFAppState().TabMenuPatientInfo ==
                                    ...
                                    return wrapWithModel(
                                      ...
                                      7) {
                                    return wrapWithModel(
                                      model: _model.operativeNoteViewModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: OperativeNoteViewWidget(),
                                    );
                                  } else if (FFAppState().TabMenuPatientInfo ==
                                      8) {
                                    return wrapWithModel(
                                      ...
                                      updateCallback: () => safeSetState(() {}),
                                      child:
                                          DischargeSummaryOperationViewWidget(),
                                    );
                                  } else {
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 16.0, 16.0, 16.0),
                                child: wrapWithModel(
                                  model: _model.dischargeSummaryViewModel1,
                                  updateCallback: () => safeSetState(() {}),
                                  child: DischargeSummaryViewWidget(),
                                ),
                              ),
                            ),
                        ],
                        ...
                        children: [
                          GestureDetector(
                            onVerticalDragDown: (details) async {
                              _model.expan = !(_model.expan ?? true);
                              safeSetState(() {});
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                          ...
                          Expanded(
                            child: wrapWithModel(
                              model: _model.dischargeSummaryViewModel2,
                              updateCallback: () => safeSetState(() {}),
                              child: DischargeSummaryViewWidget(),
                            ),
                          ),
