...
import 'add_icd10_dischage_model.dart';
export 'add_icd10_dischage_model.dart';

class AddIcd10DischageWidget extends StatefulWidget {
  const AddIcd10DischageWidget({
    super.key,
  ...
  @override
  State<AddIcd10DischageWidget> createState() => _AddIcd10DischageWidgetState();
}

class _AddIcd10DischageWidgetState extends State<AddIcd10DischageWidget> {
  late AddIcd10DischageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddIcd10DischageModel());
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(
              'บันทึกผลการวินิจฉัยผู้ป่วยใน (ICD10)',
