...
import 'item_medicalcertificate_model.dart';
export 'item_medicalcertificate_model.dart';

class ItemMedicalcertificateWidget extends StatefulWidget {
  const ItemMedicalcertificateWidget({
    super.key,
    this.medicalcertificate,
    this.examiningphysician,
    this.symptomsdetected,
    this.stopworkingdate,
    this.numberdays,
    this.diagnose,
    this.day,
    this.month,
  ...
  @override
  State<ItemMedicalcertificateWidget> createState() =>
      _ItemMedicalcertificateWidgetState();
}

class _ItemMedicalcertificateWidgetState
    extends State<ItemMedicalcertificateWidget> {
  late ItemMedicalcertificateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemMedicalcertificateModel());
