...
import 'order_sheet_view_model.dart';
export 'order_sheet_view_model.dart';

class OrderSheetViewWidget extends StatefulWidget {
  const OrderSheetViewWidget({
    super.key,
    this.day,
    this.month,
    this.year,
  ...
  @override
  State<OrderSheetViewWidget> createState() => _OrderSheetViewWidgetState();
}

class _OrderSheetViewWidgetState extends State<OrderSheetViewWidget> {
  late OrderSheetViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderSheetViewModel());
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          ...
                          collapsed: wrapWithModel(
                            model: _model.itemSOAPRNModel1,
                            updateCallback: () => safeSetState(() {}),
                            child: ItemSOAPRNWidget(),
                          ),
                          expanded: Column(
                            mainAxisSize: MainAxisSize.max,
                                  ...
                                  children: [
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          wrapWithModel(
                                            model: _model.itemMedicationModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemMedicationWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemOperationModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemOperationWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemExaminationModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemExaminationWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemOffModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemOffWidget(),
                                          ),
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          wrapWithModel(
                                            model:
                                                _model.itemHomeMedicationModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemHomeMedicationWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemOtherModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemOtherWidget(),
                                          ),
                                        ].divide(SizedBox(height: () {
                                          if (MediaQuery.sizeOf(context).width <
                                              kBreakpointSmall) {
