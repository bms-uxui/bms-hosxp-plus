...
import 'item_off_model.dart';
export 'item_off_model.dart';

class ItemOffWidget extends StatefulWidget {
  const ItemOffWidget({
    super.key,
    this.showoff,
    this.drug,
  ...
  @override
  State<ItemOffWidget> createState() => _ItemOffWidgetState();
}

class _ItemOffWidgetState extends State<ItemOffWidget> {
  late ItemOffModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemOffModel());
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0x0EF26E79), Color(0x0CBE1E2D)],
          stops: [0.0, 1.0],
