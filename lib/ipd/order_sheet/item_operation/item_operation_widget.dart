...
import 'item_operation_model.dart';
export 'item_operation_model.dart';

class ItemOperationWidget extends StatefulWidget {
  const ItemOperationWidget({
    super.key,
    this.showoff,
    this.operation,
    this.orderer,
  ...
  @override
  State<ItemOperationWidget> createState() => _ItemOperationWidgetState();
}

class _ItemOperationWidgetState extends State<ItemOperationWidget> {
  late ItemOperationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemOperationModel());
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0x0C51A1EC), Color(0x0C21629A)],
          stops: [0.0, 1.0],
