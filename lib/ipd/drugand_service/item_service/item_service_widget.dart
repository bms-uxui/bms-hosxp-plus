...
import 'item_service_model.dart';
export 'item_service_model.dart';
...
class _ItemServiceWidgetState extends State<ItemServiceWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemServiceModel());
