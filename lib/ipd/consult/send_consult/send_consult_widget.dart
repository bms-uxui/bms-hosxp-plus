...
import 'send_consult_model.dart';
export 'send_consult_model.dart';

class SendConsultWidget extends StatefulWidget {
  const SendConsultWidget({super.key});

  static String routeName = 'Send_Consult';
  static String routePath = 'sendConsult';

  @override
  State<SendConsultWidget> createState() => _SendConsultWidgetState();
}

class _SendConsultWidgetState extends State<SendConsultWidget>
    with TickerProviderStateMixin {
  late SendConsultModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendConsultModel());
                ...
                background: Opacity(
                  ...
                  child: Align(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/ChatGPT_Image_18_.._2568_11_24_09.png',
                        width: 200.0,
                        height: 200.0,
                        fit: BoxFit.cover,
                      ),
