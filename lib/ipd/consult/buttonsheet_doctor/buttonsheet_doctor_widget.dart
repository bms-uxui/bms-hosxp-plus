...
import 'buttonsheet_doctor_model.dart';
export 'buttonsheet_doctor_model.dart';

class ButtonsheetDoctorWidget extends StatefulWidget {
  const ButtonsheetDoctorWidget({super.key});

  @override
  State<ButtonsheetDoctorWidget> createState() =>
      _ButtonsheetDoctorWidgetState();
}

class _ButtonsheetDoctorWidgetState extends State<ButtonsheetDoctorWidget> {
  late ButtonsheetDoctorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetDoctorModel());
