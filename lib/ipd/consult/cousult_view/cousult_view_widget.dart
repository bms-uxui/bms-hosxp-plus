...
import 'cousult_view_model.dart';
export 'cousult_view_model.dart';

class CousultViewWidget extends StatefulWidget {
  const CousultViewWidget({super.key});

  @override
  State<CousultViewWidget> createState() => _CousultViewWidgetState();
}

class _CousultViewWidgetState extends State<CousultViewWidget> {
  late CousultViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CousultViewModel());
                ...
                Row(
                  ...
                  children: [
                        ...
                        showModalBottomSheet(
                          ...
                          builder: (context) {
                            return Padding(
                              ...
                              child: FillterConsultPatientWidget(),
                            );
                          },
                    ...
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed(SendConsultWidget.routeName);
                      },
                      child: wrapWithModel(
              ...
              onTap: () async {
                showModalBottomSheet(
                  ...
                  builder: (context) {
                    return Padding(
                      padding: MediaQuery.viewInsetsOf(context),
                      child: AskConslultDetail3Widget(),
                    );
                  },
                ).then((value) => safeSetState(() {}));
              },
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                wrapWithModel(
                                  model: _model.dateandTimeRecordeModel1,
                                  updateCallback: () => safeSetState(() {}),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'case Hx trigeminal neuralgia ขาดยาประมาณ 2 เดือนกลับมาด้วยปัญหาเจ็บแก้มขวามาก ได้จ่ายยาเดิมไป อาการไม่ดีขึ้น วันนี้มา follow up มีอาการชาปลายมือขวาเพิ่มขึ้น No evidence of dental cause ',
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                wrapWithModel(
                                  model: _model.dateandTimeRecordeModel2,
                                  updateCallback: () => safeSetState(() {}),
                                  child: DateandTimeRecordeWidget(),
                                ),
                              ].divide(SizedBox(height: 2.0)),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                model: _model.dateandTimeRecordeModel3,
                                updateCallback: () => safeSetState(() {}),
                                child: DateandTimeRecordeWidget(
                                  color: FlutterFlowTheme.of(context)
                                      .secondaryBackground,
                            ...
                            child: Stack(
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(100.0),
                                  child: Image.asset(
                                    'assets/images/ChatGPT_Image_17_.._2568_10_35_15.png',
                                    width: 200.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                wrapWithModel(
                                  model: _model.dateandTimeRecordeModel4,
                                  updateCallback: () => safeSetState(() {}),
                                  child: DateandTimeRecordeWidget(),
                                ),
                              ].divide(SizedBox(height: 2.0)),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                model: _model.dateandTimeRecordeModel5,
                                updateCallback: () => safeSetState(() {}),
                                child: DateandTimeRecordeWidget(
                                  color: FlutterFlowTheme.of(context)
                                      .secondaryBackground,
