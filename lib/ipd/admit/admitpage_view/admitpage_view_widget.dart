...
import 'admitpage_view_model.dart';
export 'admitpage_view_model.dart';

class AdmitpageViewWidget extends StatefulWidget {
  const AdmitpageViewWidget({
    super.key,
    bool? buttonReport,
    this.crossAxisCount,
    int? crossAxisCountcard,
  })  : this.buttonReport = buttonReport ?? false,
        this.crossAxisCountcard = crossAxisCountcard ?? 2;

  final bool buttonReport;
  final int? crossAxisCount;
  final int crossAxisCountcard;

  @override
  State<AdmitpageViewWidget> createState() => _AdmitpageViewWidgetState();
}

class _AdmitpageViewWidgetState extends State<AdmitpageViewWidget> {
  late AdmitpageViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmitpageViewModel());
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [Color(0xFF51A1EC), Color(0xFF21629A)],
                                stops: [0.0, 1.0],
                                begin: AlignmentDirectional(0.0, -1.0),
                                end: AlignmentDirectional(0, 1.0),
                              ),
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [Color(0xFFF38BBE), Color(0xFFD02E7F)],
                                stops: [0.0, 1.0],
                                begin: AlignmentDirectional(0.0, -1.0),
                                end: AlignmentDirectional(0, 1.0),
                              ),
