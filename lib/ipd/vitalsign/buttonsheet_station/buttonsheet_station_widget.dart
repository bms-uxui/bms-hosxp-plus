...
import 'buttonsheet_station_model.dart';
export 'buttonsheet_station_model.dart';

class ButtonsheetStationWidget extends StatefulWidget {
  const ButtonsheetStationWidget({super.key});

  @override
  State<ButtonsheetStationWidget> createState() =>
      _ButtonsheetStationWidgetState();
}

class _ButtonsheetStationWidgetState extends State<ButtonsheetStationWidget> {
  late ButtonsheetStationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetStationModel());
