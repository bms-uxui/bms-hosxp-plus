...
import 'add_nursingrecords_model.dart';
export 'add_nursingrecords_model.dart';

class AddNursingrecordsWidget extends StatefulWidget {
  const AddNursingrecordsWidget({super.key});

  static String routeName = 'Add_Nursingrecords';
  static String routePath = 'addNursingrecords';

  @override
  State<AddNursingrecordsWidget> createState() =>
      _AddNursingrecordsWidgetState();
}

class _AddNursingrecordsWidgetState extends State<AddNursingrecordsWidget>
    with TickerProviderStateMixin {
  late AddNursingrecordsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNursingrecordsModel());
                                                    ...
                                                    child: Padding(
                                                      padding: MediaQuery
                                                          .viewInsetsOf(
                                                              context),
                                                      child:
                                                          ButtonsheetNursingrecordsTypeWidget(),
                                                    ),
                                                  );
                                                },
                                              ).then((value) =>
                                    ...
                                    children: [
                                      ...
                                      Stack(
                                        children: [
                                          ...
                                          if (_model.tabmenu == 2)
                                            wrapWithModel(
                                              model: _model.formVitalsignModel,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child: FormVitalsignWidget(),
                                            ),
                                          if (_model.tabmenu == 3)
                                            wrapWithModel(
                                              model: _model.formFluidModel,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child: FormFluidWidget(),
                                            ),
                                          if (_model.tabmenu == 4)
                                            wrapWithModel(
                                              model: _model.formPregnancyModel,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child: FormPregnancyWidget(),
                                            ),
                                        ],
                                      ),
