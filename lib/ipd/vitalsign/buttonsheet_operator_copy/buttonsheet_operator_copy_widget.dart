...
import 'buttonsheet_operator_copy_model.dart';
export 'buttonsheet_operator_copy_model.dart';

class ButtonsheetOperatorCopyWidget extends StatefulWidget {
  const ButtonsheetOperatorCopyWidget({super.key});

  @override
  State<ButtonsheetOperatorCopyWidget> createState() =>
      _ButtonsheetOperatorCopyWidgetState();
}

class _ButtonsheetOperatorCopyWidgetState
    extends State<ButtonsheetOperatorCopyWidget> {
  late ButtonsheetOperatorCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetOperatorCopyModel());
