...
import 'add_treatment_i_p_d_model.dart';
export 'add_treatment_i_p_d_model.dart';

class AddTreatmentIPDWidget extends StatefulWidget {
  const AddTreatmentIPDWidget({super.key});

  static String routeName = 'Add_Treatment_IPD';
  static String routePath = 'addTreatmentIPD';

  @override
  State<AddTreatmentIPDWidget> createState() => _AddTreatmentIPDWidgetState();
}

class _AddTreatmentIPDWidgetState extends State<AddTreatmentIPDWidget>
    with TickerProviderStateMixin {
  late AddTreatmentIPDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddTreatmentIPDModel());
