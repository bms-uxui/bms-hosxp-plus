...
import 'buttonsheet_clinic_model.dart';
export 'buttonsheet_clinic_model.dart';

class ButtonsheetClinicWidget extends StatefulWidget {
  const ButtonsheetClinicWidget({super.key});

  @override
  State<ButtonsheetClinicWidget> createState() =>
      _ButtonsheetClinicWidgetState();
}

class _ButtonsheetClinicWidgetState extends State<ButtonsheetClinicWidget> {
  late ButtonsheetClinicModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetClinicModel());
