...
import 'buttonsheet_department_model.dart';
export 'buttonsheet_department_model.dart';

class ButtonsheetDepartmentWidget extends StatefulWidget {
  const ButtonsheetDepartmentWidget({super.key});

  @override
  State<ButtonsheetDepartmentWidget> createState() =>
      _ButtonsheetDepartmentWidgetState();
}

class _ButtonsheetDepartmentWidgetState
    extends State<ButtonsheetDepartmentWidget> {
  late ButtonsheetDepartmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetDepartmentModel());
