...
import 'add_refer_model.dart';
export 'add_refer_model.dart';

class AddReferWidget extends StatefulWidget {
  const AddReferWidget({super.key});

  static String routeName = 'Add_Refer';
  static String routePath = 'addRefer';

  @override
  State<AddReferWidget> createState() => _AddReferWidgetState();
}

class _AddReferWidgetState extends State<AddReferWidget>
    with TickerProviderStateMixin {
  late AddReferModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddReferModel());
        ...
        body: NestedScrollView(
          ...
          headerSliverBuilder: (context, _) => [
            SliverAppBar(
              ...
              title: Text(
                'การส่งตัวรับบริการสถานพยาบาลอื่น',
