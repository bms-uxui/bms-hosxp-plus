...
import 'add_admit_model.dart';
export 'add_admit_model.dart';

class AddAdmitWidget extends StatefulWidget {
  const AddAdmitWidget({super.key});

  static String routeName = 'Add_Admit';
  static String routePath = 'addAdmit';

  @override
  State<AddAdmitWidget> createState() => _AddAdmitWidgetState();
}

class _AddAdmitWidgetState extends State<AddAdmitWidget>
    with TickerProviderStateMixin {
  late AddAdmitModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAdmitModel());
