...
import 'info_patient_e_r_view_model.dart';
export 'info_patient_e_r_view_model.dart';

class InfoPatientERViewWidget extends StatefulWidget {
  const InfoPatientERViewWidget({super.key});

  @override
  State<InfoPatientERViewWidget> createState() =>
      _InfoPatientERViewWidgetState();
}

class _InfoPatientERViewWidgetState extends State<InfoPatientERViewWidget> {
  late InfoPatientERViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InfoPatientERViewModel());
        ...
        child: ListView(
          ...
          children: [
                  ...
                  child: ExpandableNotifier(
                    ...
                    child: ExpandablePanel(
                      ...
                      expanded: Column(
                        ...
                        children: [
                          wrapWithModel(
                            model: _model.treatmentsummaryreportViewModel,
                            updateCallback: () => safeSetState(() {}),
                            child: TreatmentsummaryreportViewWidget(),
                          ),
                          Row(
                            mainAxisSize: MainAxisSize.max,
                            mainAxisAlignment: MainAxisAlignment.center,
                ...
                children: [
                  ...
                  MasonryGridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return [
                        () => wrapWithModel(
                              model: _model.itemChronicDiseaseModel,
                              updateCallback: () => safeSetState(() {}),
                              child: ItemChronicDiseaseWidget(),
                            ),
                        () => wrapWithModel(
                              model: _model.itemCongenitalDiseaseModel,
                              updateCallback: () => safeSetState(() {}),
                              child: ItemCongenitalDiseaseWidget(),
                            ),
                        () => wrapWithModel(
                              ...
                              return [
                                ...
                                () => Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '257 ห้องตรวจอุบัติเหตุ-ฉุกเฉิน (ER)',
                                          maxLines: 1,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed(ERAdmissionEditWidget.routeName);
                        },
                        child: wrapWithModel(
                      ...
                      child: Column(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.resuscitationESIModel,
                                updateCallback: () => safeSetState(() {}),
                                child: ResuscitationESIWidget(),
                              ),
                              RichText(
                                textScaler: MediaQuery.of(context).textScaler,
                                text: TextSpan(
            ...
            Padding(
              ...
              child: Builder(
                builder: (context) {
                  if (FFAppState().ConditionatERdischarge == 'Admit') {
                    return wrapWithModel(
                      model: _model.itemAdmitModel,
                      updateCallback: () => safeSetState(() {}),
                      child: ItemAdmitWidget(),
                    );
                  } else if ((FFAppState().ConditionatERdischarge ==
                          'Refer ทางกาย') ||
                      (FFAppState().ConditionatERdischarge == 'Refer ทางจิต')) {
                    return wrapWithModel(
                      model: _model.itemReferModel,
                      updateCallback: () => safeSetState(() {}),
                      child: ItemReferWidget(),
                    );
                  } else if (FFAppState().ConditionatERdischarge == 'ตาย') {
                    return wrapWithModel(
                      model: _model.itemExpiredModel,
                      updateCallback: () => safeSetState(() {}),
                      child: ItemExpiredWidget(),
                    );
                  } else {
                    return Container(
                      decoration: BoxDecoration(),
