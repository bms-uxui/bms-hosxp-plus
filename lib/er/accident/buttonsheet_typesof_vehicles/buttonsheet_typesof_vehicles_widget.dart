...
import 'buttonsheet_typesof_vehicles_model.dart';
export 'buttonsheet_typesof_vehicles_model.dart';

class ButtonsheetTypesofVehiclesWidget extends StatefulWidget {
  const ButtonsheetTypesofVehiclesWidget({super.key});

  @override
  State<ButtonsheetTypesofVehiclesWidget> createState() =>
      _ButtonsheetTypesofVehiclesWidgetState();
}

class _ButtonsheetTypesofVehiclesWidgetState
    extends State<ButtonsheetTypesofVehiclesWidget> {
  late ButtonsheetTypesofVehiclesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetTypesofVehiclesModel());
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              updateCallback: () => safeSetState(() {}),
                              child: ItemListPrimaryWidget(
                                title: 'รถยนต์โดยสาร(รถบัส รถเมล์)',
                                showline: true,
                              ),
                            ),
                            wrapWithModel(
