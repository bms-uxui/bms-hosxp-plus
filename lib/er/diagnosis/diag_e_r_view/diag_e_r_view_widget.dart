...
import 'diag_e_r_view_model.dart';
export 'diag_e_r_view_model.dart';

class DiagERViewWidget extends StatefulWidget {
  const DiagERViewWidget({super.key});

  @override
  State<DiagERViewWidget> createState() => _DiagERViewWidgetState();
}

class _DiagERViewWidgetState extends State<DiagERViewWidget> {
  late DiagERViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiagERViewModel());
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  wrapWithModel(
                    model: _model.itemDiagnosisTextModel1,
                    updateCallback: () => safeSetState(() {}),
                    child: ItemDiagnosisTextWidget(),
                  ),
                  wrapWithModel(
                    model: _model.itemDiagnosisTextModel2,
                    updateCallback: () => safeSetState(() {}),
                    child: ItemDiagnosisTextWidget(
                      finalcolor2: FlutterFlowTheme.of(context).customColor10,
                      finalcolor1: FlutterFlowTheme.of(context).customColor9,
                      finaliconcolor:
                          FlutterFlowTheme.of(context).secondaryBackground,
                      auditcolor2: FlutterFlowTheme.of(context).customColor10,
                      auditcolor1: FlutterFlowTheme.of(context).customColor9,
                      auditiconcolor:
                          FlutterFlowTheme.of(context).secondaryBackground,
                    ),
                  ),
