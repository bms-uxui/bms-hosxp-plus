...
import 'item_drug_e_r_model.dart';
export 'item_drug_e_r_model.dart';

class ItemDrugERWidget extends StatefulWidget {
  const ItemDrugERWidget({
    super.key,
    this.num,
    this.drug,
    this.quantity,
  ...
  @override
  State<ItemDrugERWidget> createState() => _ItemDrugERWidgetState();
}

class _ItemDrugERWidgetState extends State<ItemDrugERWidget> {
  late ItemDrugERModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemDrugERModel());
