...
import 'e_m_r_er_view_model.dart';
export 'e_m_r_er_view_model.dart';

class EMRErViewWidget extends StatefulWidget {
  const EMRErViewWidget({super.key});

  @override
  State<EMRErViewWidget> createState() => _EMRErViewWidgetState();
}

class _EMRErViewWidgetState extends State<EMRErViewWidget> {
  late EMRErViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EMRErViewModel());
