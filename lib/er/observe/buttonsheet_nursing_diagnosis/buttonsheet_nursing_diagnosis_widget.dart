...
import 'buttonsheet_nursing_diagnosis_model.dart';
export 'buttonsheet_nursing_diagnosis_model.dart';

class ButtonsheetNursingDiagnosisWidget extends StatefulWidget {
  const ButtonsheetNursingDiagnosisWidget({super.key});

  @override
  State<ButtonsheetNursingDiagnosisWidget> createState() =>
      _ButtonsheetNursingDiagnosisWidgetState();
}

class _ButtonsheetNursingDiagnosisWidgetState
    extends State<ButtonsheetNursingDiagnosisWidget> {
  late ButtonsheetNursingDiagnosisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetNursingDiagnosisModel());
