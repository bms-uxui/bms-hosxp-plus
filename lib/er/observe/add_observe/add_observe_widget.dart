...
import 'add_observe_model.dart';
export 'add_observe_model.dart';

class AddObserveWidget extends StatefulWidget {
  const AddObserveWidget({super.key});

  static String routeName = 'Add_Observe';
  static String routePath = 'addObserve';

  @override
  State<AddObserveWidget> createState() => _AddObserveWidgetState();
}

class _AddObserveWidgetState extends State<AddObserveWidget>
    with TickerProviderStateMixin {
  late AddObserveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddObserveModel());
