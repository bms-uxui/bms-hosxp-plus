...
import 'template_general_emergency_model.dart';
export 'template_general_emergency_model.dart';

class TemplateGeneralEmergencyWidget extends StatefulWidget {
  const TemplateGeneralEmergencyWidget({super.key});

  @override
  State<TemplateGeneralEmergencyWidget> createState() =>
      _TemplateGeneralEmergencyWidgetState();
}

class _TemplateGeneralEmergencyWidgetState
    extends State<TemplateGeneralEmergencyWidget> {
  late TemplateGeneralEmergencyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TemplateGeneralEmergencyModel());
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (_model.checkboxValue11 == true)
                                Stack(
                                  children: [
                                    Container(
                                      width: double.infinity,
