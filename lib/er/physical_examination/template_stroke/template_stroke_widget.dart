...
import 'template_stroke_model.dart';
export 'template_stroke_model.dart';

class TemplateStrokeWidget extends StatefulWidget {
  const TemplateStrokeWidget({super.key});

  @override
  State<TemplateStrokeWidget> createState() => _TemplateStrokeWidgetState();
}

class _TemplateStrokeWidgetState extends State<TemplateStrokeWidget> {
  late TemplateStrokeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TemplateStrokeModel());
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    wrapWithModel(
                      model: _model.itemDrugOderModel1,
                    ...
                    wrapWithModel(
                      model: _model.itemDrugOderModel2,
                      updateCallback: () => safeSetState(() {}),
                      child: ItemDrugOderWidget(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (_model.checkboxValue17 == true)
                                Stack(
                                  children: [
                                    Container(
                                      width: double.infinity,
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Consult Neuro / Stroke fast track',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily:
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    wrapWithModel(
                      model: _model.itemSetORModel,
                      updateCallback: () => safeSetState(() {}),
                      child: ItemSetORWidget(
                        name: 'Thrombectomy',
                        description: 'ดึงลิ่มเลือดออก',
                      ),
                    ),
                  ].divide(SizedBox(height: 8.0)),
                ),
