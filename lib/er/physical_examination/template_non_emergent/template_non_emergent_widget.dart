...
import 'template_non_emergent_model.dart';
export 'template_non_emergent_model.dart';

class TemplateNonEmergentWidget extends StatefulWidget {
  const TemplateNonEmergentWidget({super.key});

  @override
  State<TemplateNonEmergentWidget> createState() =>
      _TemplateNonEmergentWidgetState();
}

class _TemplateNonEmergentWidgetState extends State<TemplateNonEmergentWidget> {
  late TemplateNonEmergentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TemplateNonEmergentModel());
