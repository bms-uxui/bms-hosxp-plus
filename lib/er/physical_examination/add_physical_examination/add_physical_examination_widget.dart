...
import 'add_physical_examination_model.dart';
export 'add_physical_examination_model.dart';

class AddPhysicalExaminationWidget extends StatefulWidget {
  const AddPhysicalExaminationWidget({super.key});

  static String routeName = 'Add_PhysicalExamination';
  static String routePath = 'addPhysicalExamination';

  @override
  State<AddPhysicalExaminationWidget> createState() =>
      _AddPhysicalExaminationWidgetState();
}

class _AddPhysicalExaminationWidgetState
    extends State<AddPhysicalExaminationWidget> with TickerProviderStateMixin {
  late AddPhysicalExaminationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddPhysicalExaminationModel());
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          wrapWithModel(
                                            model:
                                                _model.iconButtonTertiaryModel1,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                                                                  ...
                                                                                  builder: (context) {
                                                                                    return GestureDetector(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        ...
                                                                                        child: ButtonsheetPhysicalExaminationWidget(),
                                                                                      ),
                                                                                    );
                                                                                  },
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            cursorColor:
                                                                                FlutterFlowTheme.of(context).primary,
                                                                            validator:
                                                                                _model.textController22Validator.asValidator(context),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                    ].divide(SizedBox(
