...
import 'template_s_t_e_m_i_model.dart';
export 'template_s_t_e_m_i_model.dart';

class TemplateSTEMIWidget extends StatefulWidget {
  const TemplateSTEMIWidget({super.key});

  @override
  State<TemplateSTEMIWidget> createState() => _TemplateSTEMIWidgetState();
}

class _TemplateSTEMIWidgetState extends State<TemplateSTEMIWidget> {
  late TemplateSTEMIModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TemplateSTEMIModel());
