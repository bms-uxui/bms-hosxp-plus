...
import 'buttonsheet_ordering_doctor_model.dart';
export 'buttonsheet_ordering_doctor_model.dart';

class ButtonsheetOrderingDoctorWidget extends StatefulWidget {
  const ButtonsheetOrderingDoctorWidget({super.key});

  @override
  State<ButtonsheetOrderingDoctorWidget> createState() =>
      _ButtonsheetOrderingDoctorWidgetState();
}

class _ButtonsheetOrderingDoctorWidgetState
    extends State<ButtonsheetOrderingDoctorWidget> {
  late ButtonsheetOrderingDoctorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetOrderingDoctorModel());
