...
import 'buttonsheet_i_c_d9_model.dart';
export 'buttonsheet_i_c_d9_model.dart';

class ButtonsheetICD9Widget extends StatefulWidget {
  const ButtonsheetICD9Widget({
    super.key,
    required this.user,
  });
  ...
  @override
  State<ButtonsheetICD9Widget> createState() => _ButtonsheetICD9WidgetState();
}

class _ButtonsheetICD9WidgetState extends State<ButtonsheetICD9Widget> {
  late ButtonsheetICD9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonsheetICD9Model());
