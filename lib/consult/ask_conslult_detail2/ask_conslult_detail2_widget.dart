...
import 'ask_conslult_detail2_model.dart';
export 'ask_conslult_detail2_model.dart';

class AskConslultDetail2Widget extends StatefulWidget {
  const AskConslultDetail2Widget({super.key});

  @override
  State<AskConslultDetail2Widget> createState() =>
      _AskConslultDetail2WidgetState();
}

class _AskConslultDetail2WidgetState extends State<AskConslultDetail2Widget>
    with TickerProviderStateMixin {
  late AskConslultDetail2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AskConslultDetail2Model());
