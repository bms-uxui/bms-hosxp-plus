...
import 'patient_info_organ_donation_detail_model.dart';
export 'patient_info_organ_donation_detail_model.dart';

class PatientInfoOrganDonationDetailWidget extends StatefulWidget {
  const PatientInfoOrganDonationDetailWidget({super.key});

  static String routeName = 'Patient_Info_OrganDonationDetail';
  static String routePath = 'patientInfoOrganDonationDetail';

  @override
  State<PatientInfoOrganDonationDetailWidget> createState() =>
      _PatientInfoOrganDonationDetailWidgetState();
}

class _PatientInfoOrganDonationDetailWidgetState
    extends State<PatientInfoOrganDonationDetailWidget>
    with TickerProviderStateMixin {
  late PatientInfoOrganDonationDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientInfoOrganDonationDetailModel());
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          wrapWithModel(
                                            model: _model.approachedModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ApproachedWidget(),
                                          ),
                                        ],
                                      ),
                                      Text(
                                              ...
                                              child: Padding(
                                                padding:
                                                    MediaQuery.viewInsetsOf(
                                                        context),
                                                child:
                                                    DiscussionnotinitiatedPreviewWidget(),
                                              ),
                                            );
                                          },
                                                      ...
                                                      Align(
                                                        alignment:
                                                            AlignmentDirectional(
                                                                -1.0, 0.0),
                                                        child: Text(
                                                          'เอกสารการยินยอมก่อนบริจาคดวงตา',
