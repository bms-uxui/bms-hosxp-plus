...
import 'animation_mobile_model.dart';
export 'animation_mobile_model.dart';

class AnimationMobileWidget extends StatefulWidget {
  const AnimationMobileWidget({super.key});

  @override
  State<AnimationMobileWidget> createState() => _AnimationMobileWidgetState();
}

class _AnimationMobileWidgetState extends State<AnimationMobileWidget>
    with TickerProviderStateMixin {
  late AnimationMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnimationMobileModel());
